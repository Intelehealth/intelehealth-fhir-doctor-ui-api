 ...
 * 'module/ihmodule/ihmoduleLink.form'.
 */
@Controller("ihmodule.APIfordoctorUIController")
@RequestMapping(value = "module/ihmodule/ihmodule.form")
public class APIfordoctorUIController {
