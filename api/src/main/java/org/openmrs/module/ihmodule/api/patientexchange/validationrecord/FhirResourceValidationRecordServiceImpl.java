 ...
 * (e.g. AOP) live here.
 */
@Service("fhirResourceValidationRecordService")
public class FhirResourceValidationRecordServiceImpl implements FhirResourceValidationRecordService {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(FhirResourceValidationRecordServiceImpl.class);
