...
@Service("mpiDuplicateReviewResolutionService")
public class MpiDuplicateReviewResolutionServiceImpl implements MpiDuplicateReviewResolutionService {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(MpiDuplicateReviewResolutionServiceImpl.class);
