...
/**
 * Exponential backoff for central FHIR patient sync retries (aligned with SHR
 * {@code ShrSyncRetryPolicy}): 1m, 5m, 15m, 1h, 6h, 12h, 24h; max 10 attempts.
 */
public final class PatientSyncRetryPolicy {
	
	public static final int MAX_ATTEMPTS = 10;
	
	private static final int[] BACKOFF_MINUTES = { 1, 5, 15, 60, 360, 720, 1440 };
	
	private PatientSyncRetryPolicy() {
	}
